...
export const GetData = (params) => (dispatch) => {
  ...
  return axios
    .get("https://expedia-backend-api.onrender.com/stays", params)
    .then((res) => {
...
export const fetchData = (params) => (dispatch) => {
  ...
  return axios
    .get(`https://expedia-backend-api.onrender.com/stays?q=${params}`)
    .then((res) => {
      dispatch({
...
export const GetSingleProduct = (_id) => (dispatch) => {
  ...
  return axios
    .get(`https://expedia-backend-api.onrender.com/stays/${_id}`)
    .then((r) => {
